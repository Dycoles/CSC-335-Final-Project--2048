...
public class Tile {
	...
	/**
	 * Create tile and set initial tile value to 0.
	 */
	public Tile() {
		value = 0;
	}
	...
	/**
	 * Create tile and set initial value to specified val
	...
	/**
	 * Initializes the tile with 2 or 4 with a 7/10 chance for a 2
	 */
	 ...
	 * @return True if spot is empty, otherwise false
	 */
